...
<head>
  ...
  <title>AdminLTE 3 | Edit Game</title>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="<c:url value='/admin/game?action=view'/>" class="nav-link active">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<c:url value='/admin/game?action=view'/>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Overview</p>
                </a>
              </li>
			  <li class="nav-item">
                <a href="<c:url value='/admin/game?action=add'/>" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>New or Edit</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Add/Edit Game</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Add/Edit Game</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Add/Edit Game</h3>
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" id="title" value="${game != null ? game.title : ''}" class="form-control">
              </div>
              <div class="form-group">
                <label for="href">Href</label>
                <input type="text" id="href" value="${game != null ? game.href : ''}" class="form-control">
              </div>
              <div class="form-group">
				<div class="row">
					<div class="col-9">
						<div class="row">
							<div class="col-12 form-group">
								...
								<textarea id="description" class="form-control" rows="4">${game != null ? game.description : ''}</textarea>
							</div>
							<div class="col-12 form-group">
								<label for="poster">Poster</label>
								<input type="text" id="poster" value="${game != null ? game.poster : ''}" class="form-control"/>
					...
					<div class="col-3">
						...
						<div style="width: 100%; height: 200px; border: 1px dotted gray">
							 <c:url value='/templates/user/assets/images/gallery-10.jpg' var="defaultImg"/>
							 <input type="hidden" value="${defaultImg}" id="defaultImg"/>
							<img id="imgPreview" src="${game != null ? game.poster : defaultImg}" height="100%" width="100%" />
						</div>
					</div>
				</div>
...
<script>
	...
	$('#resetBtn').click(function(){
		...
		if (posterOrigin.length > 0) {
			...
			$('#imgPreview').attr('src', $('#defaultImg').val());
		}
	});
	...
	$('#submitBtn').click(function(){
		...
		if (isEdit == 'true') {
			url = '/gamingstore/admin/game?action=edit&href=' + hrefOrigin;
		} else {
			url = '/gamingstore/admin/game?action=add';
		}
		...
		$.ajax({
			...
			window.location.href = "http://localhost:8080/gamingstore/admin/game?action=view";
		}).fail(function(error){
