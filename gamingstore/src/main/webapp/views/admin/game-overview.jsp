...
<head>
  ...
  <title>AdminLTE 3 | Game Overview</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<c:url value='/admin/game?action=add'/>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>New or Edit</p>
                </a>
              </li>
    ...
    <section class="content">
      	<div class="card">
              <div class="card-header">
                <h3 class="card-title">List Games</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <tbody>
                  		<c:forEach items="${games}" var="item">
                  			<tr>
                  				...
                  				<td><a href="<c:url value='/game?action=preview&id=${item.href}'/>">${item.href}</a></td>
                  				<td>
                  					<img src="${item.poster}" width="150px" height="150px"/>
                  				</td>
                  				<td>
                  					<a href="<c:url value='/admin/game?action=edit&href=${item.href}'/>" type="button" class="btn btn-block btn-success btn-sm">Edit</a>
                  					<button type="button" onClick="deleteGame('${item.href}')" class="btn btn-block btn-danger btn-sm">Delete</button>
                  				</td>
                  			</tr>
                  		</c:forEach>
                  </tbody>
...
<script>
	function deleteGame(href) {
		$.ajax({
		    url: '/gamingstore/admin/game?action=delete&href=' + href
		}).then(function(data) {
